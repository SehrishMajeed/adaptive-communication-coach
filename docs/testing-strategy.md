...
| Frontend | Render actual API contract fixtures; unavailable/abstained results, workflow route visibility, request error/retry, comparison visibility, task preservation; fake MediaRecorder/tracks/timers for manual and automatic stop, one completion, unmount cleanup, delayed permissions and StrictMode |
