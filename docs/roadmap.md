...
- Current implementation note: the coaching write gate now blocks interventions and comparisons unless the evaluation is usable, quote-verified and actionable.
...
- Current implementation note: Phase 4D persists workflow route and reason on durable attempts for replayable audit evidence.
- Current implementation note: Phase 4E adds an owner-scoped current-session attempt history endpoint.
...
- Current implementation note: Phase 5B adds explicit scenario, audience and goal setup to the web welcome flow.
- Current implementation note: Phase 5C keeps the selected scenario, audience, goal and target duration visible during recording, review and feedback.
